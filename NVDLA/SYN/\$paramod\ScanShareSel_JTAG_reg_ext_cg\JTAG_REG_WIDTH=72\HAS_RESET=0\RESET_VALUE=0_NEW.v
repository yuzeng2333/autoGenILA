module \$paramod\ScanShareSel_JTAG_reg_ext_cg\JTAG_REG_WIDTH=72\HAS_RESET=0\RESET_VALUE=0 (D, clk, reset_, scanin, sel, shiftDR, Q, scanout);
  ...
  assign Q_conn = { qualified_scanin_wire, Q[71:1] };
  assign clk_wire = clk;
  assign next_Q = D;
endmodule
