...
@.str = private unnamed_addr constant [14 x i8] c"output is %d\0A\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  %7 = call i64 bitcast (i128 (i64, i32)* @adder to i64 (i32, i32)*)(i32 %5, i32 %6)
...
define fastcc i128 @adder(i64 %"\\cpuregs[2]___#8", i32 %"\\cpuregs[3]___#8") #2 {
"bb_;_\\cpuregs[1]":
...
attributes #2 = { noinline norecurse nounwind readnone willreturn }
